...
function LightAttackBar:update()
    ...
    if self.perfect then
        ...
        if self.perfect_counter == 1 then
            if self.sprite.color[1] ~= 192/255 or self.sprite.color[2] ~= 0 or self.sprite.color[3] ~= 0 then
                self.sprite:setColor(192/255, 0, 0)
            end
        elseif self.perfect_counter == 2 then
            if self.sprite.color[1] ~= 128/255 or self.sprite.color[2] ~= 1 or self.sprite.color[3] ~= 1 then
                self.sprite:setColor(128/255, 1, 1)
            end
        else
            if self.sprite.color[1] ~= 1 or self.sprite.color[2] ~= 1 or self.sprite.color[3] ~= 64/255 then
