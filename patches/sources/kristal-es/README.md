# Kristal Engine — Spanish

This package contains the Spanish translation data and graphics maintained for the Kristal Launcher external-patch format.
...
- Run `build.ps1` to regenerate `payload/kristal_es/translations.lua`, `patch.json`, and the `.klpatch` archive.
