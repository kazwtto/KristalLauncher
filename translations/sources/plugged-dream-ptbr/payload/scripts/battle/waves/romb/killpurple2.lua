local KillPurple, super = Class(Wave, "romb/killpurple2")

function KillPurple:init()
    super.init(self)

    self:setArenaSize(210, 79)
...
function KillPurple:onStart()
    ...
    -- self:spawnBullet("killpurple/spark_right_long", Game.battle.arena.left - 115, Game.battle.soul.y)
    self:spawnBullet("killpurple/spark_right", Game.battle.arena.left, Game.battle.soul.y + 29.2)
    -- self:spawnBullet("killpurple/spark_left", Game.battle.arena.left, Game.battle.soul.y + 58.4)

    self:spawnBullet("killpurple/spark_down", Game.battle.soul.x - 89.6, Game.battle.arena.top)
    self:spawnBullet("killpurple/spark_up", Game.battle.soul.x - 30.2, Game.battle.arena.top)
    self:spawnBullet("killpurple/spark_down", Game.battle.soul.x + 30.2, Game.battle.arena.top)
    self:spawnBullet("killpurple/spark_up", Game.battle.soul.x + 89.6, Game.battle.arena.top)
end

function KillPurple:update()
    if self.purplekill_points == 6 then
