    ...
    },
    {
      ...
      objects = {
        ...
        },
        {
          ...
          visible = true,
          properties = {
            ["text1"] = "* O silêncio ecoa na escuridão\ndeste cenário familiar,\nmas diferente.",
            ["text2"] = "* O poder de evitar copiar\nmúsicas oficiais brilha em\nvocê."
          }
        },
        {
          id = 28,
        ...
        },
        {
          ...
          properties = {
            ["actor"] = "wall",
            ["flagcheck"] = "wall_hit",
            ["text1"] = "* Eu sou o Guardião da Parede.[wait:5]\n* Esta Parede é Proibida para vocês,\nseus arrombadores de parede."
          }
        }
      }
    },
